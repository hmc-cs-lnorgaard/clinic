function horizonInit(div) {
    ...
    function horizonUpdate() {
        ...
        // The variable "names" holds the data that will be used in the horizon plots. 
        // Slice to get the range of data you want. For example, .slice(0, 10) 
        // would get the first 10 rows of data from the file.
        var names = d3.keys($data.summaryTimeslice.breakdown).slice(0,5);
        ...
        // Populate the variable "parents" with the selected data from "names"
        ...
        row // Adds the URL path on the left
            .append("div").attr("class", "span3 name");

        row // Adds the horizon plot on the right
            .append("div").attr("class", "span9")
            .append("svg")
            .attr("width", $data.width) // controls the width of each horizon plot
        ...
        parents
            ...
            .attr("height", height) // controls the height of each horizon plot
    ...
    // Increases or decreases how many bands are in each horizon plot (the -/+ buttons)
